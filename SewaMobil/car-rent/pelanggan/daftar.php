...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	if ($update) {
		$sql = "UPDATE pelanggan SET no_ktp='$_POST[no_ktp]', nama='$_POST[nama]', no_sim='$_POST[no_sim]', no_telp='$_POST[no_telp]', alamat='$_POST[alamat]', username='$_POST[username]'";
		if ($_POST["password"] != "") {
			$sql .= ", password='".md5($_POST["password"])."'";
		}
		$sql .= " WHERE id_pelanggan='$_SESSION[pelanggan][id]'";
	} else {
		$sql = "INSERT INTO pelanggan VALUES (NULL, '$_POST[no_ktp]', '$_POST[nama]', '$_POST[no_sim]', '$_POST[no_telp]', '$_POST[alamat]', '$_POST[username]', '".md5($_POST["password"])."')";
	}
		...
		<div class="col-md-8">
			...
			<form action="<?=$_SERVER['REQUEST_URI']?>" method="POST">
				...
				<div class="form-group">
					...
					<input type="no_sim" name="no_sim" class="form-control" <?= (!$update) ?: 'value="'.$row["no_sim"].'"' ?>>
				</div>
				<div class="form-group">
