...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	if ($update) {
		$sql = "UPDATE pelanggan SET no_ktp='$_POST[no_ktp]', nama='$_POST[nama]', no_sim='$_POST[no_sim]', alamat='$_POST[alamat]', telp='$_POST[no_telp]', username='$_POST[username]'";
		if ($_POST["password"] != "") {
			$sql .= ", password='".md5($_POST["password"])."'";
		}
		$sql .= " WHERE id_pelanggan='$_GET[key]'";
	} else {
		$sql = "INSERT INTO pelanggan VALUES (NULL, '$_POST[no_ktp]', '$_POST[nama]', '$_POST[no_sim]', '$_POST[alamat]', '$_POST[no_telp]', '$_POST[username]', '".md5($_POST["password"])."')";
	}
	        ...
	        <div class="panel-body">
	            <form action="<?=$_SERVER['REQUEST_URI']?>" method="POST">
	                ...
	                <div class="form-group">
	                    ...
	                    <input type="text" name="no_sim" class="form-control" <?= (!$update) ?: 'value="'.$row["no_sim"].'"' ?>>
	                </div>
	                <div class="form-group">
